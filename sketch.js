...
var END = 0;
var gameState = 1;
var phil, philImage, back, backImage, sword, swordImage, heart, heartImage, score, ozzyImage, time, pegImage, peg, sword2Image, hades, hadesImage, health, fireImage, fire1, fire_2, hornImage;
...
function fire() {
  if (score >= 30 && (health > 0)) {
    if (World.frameCount % 180 === 0) {
      ...
      fire.velocityX = -18;
      fire.lifetime = 100;
      fire.setCollider("circle", 0, 150, 240);
      fireGroup.add(fire);
    }
...
function fire2() {
  if (score >= 30 && (health > 0)) {
    if (World.frameCount % 190 === 0) {
      ...
      fire2.velocityX = -18;
      fire2.lifetime = 100;
      fire2.setCollider("circle", 0, 150, 240);
...
function fire3() {
  if (score >= 30 && (health > 0)) {
    if (World.frameCount % 200 === 0) {
      ...
      fire3.velocityX = -18;
      fire3.lifetime = 100;
      fire3.setCollider("circle", 0, 150, 240);
